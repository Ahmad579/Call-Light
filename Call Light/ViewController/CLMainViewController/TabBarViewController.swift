...
//private let TABBAR_INDICATOR_VIEW_HEIGHT = 4 as? unsigned short int
...
class TabBarViewController: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        self.tabBar.items![0].selectedImage = UIImage(named:"friend-requestSel")!.withRenderingMode(.alwaysOriginal)
        (self.tabBar.items![0] ).image = UIImage(named:"friend-requestUnSelect")!.withRenderingMode(.alwaysOriginal)
        ...
        self.tabBar.items![2].selectedImage = UIImage(named:"userSelect")!.withRenderingMode(.alwaysOriginal)
        (self.tabBar.items![2] ).image = UIImage(named:"man-user")!.withRenderingMode(.alwaysOriginal)
        
        self.tabBar.items![3].selectedImage = UIImage(named:"history-clock-button")!.withRenderingMode(.alwaysOriginal)
        (self.tabBar.items![3] ).image = UIImage(named:"history-clock-buttonUn")!.withRenderingMode(.alwaysOriginal)
